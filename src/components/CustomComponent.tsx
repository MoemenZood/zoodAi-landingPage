...
<div> 
<img className="flex-grow w-[750px]" src="../../four.jpg" alt="image"/>
</div> 
...
<div> 
<img className="flex-grow " src="../../two.webp" alt="image"/>
</div> 
<div className="flex flex-col justify-center px-[30px] gap-10"> 
...
<div className="flex  px-[150px] my-6 mb-[30px] "> 
<div> 
<img className="flex-grow w-[624px]" src="../../three.webp" alt="image"/>
</div> 
<div className="flex flex-col justify-center px-[30px] gap-10"> 
